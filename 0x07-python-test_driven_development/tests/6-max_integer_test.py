...
class TestMaxInteger(unittest.TestCase):
    ...
    def test_max_int(self):
        self.assertEqual(max_integer([50, -2, 100, 3]), 100)

    def test_empty_list(self):
        self.assertEqual(max_integer([]), None)

    def test_repeated_num(self):
    ...
    def test_max_operated_integer(self):
        self.assertEqual(max_integer([-9, -5 * -5, 12, -1]), 25)

    def test_negtive_num(self):
        self.assertEqual(max_integer([-10, -5, -2, -9]), -2)
    ...
    def test_big_list(self):
        self.assertEqual(max_integer([
            ...
            919, 918, 917, 1001, 915, 914, 913, 912, 911, 910,
            909, 908, 907, 906, 905, 904, 903, 902, 901]), 1001)
